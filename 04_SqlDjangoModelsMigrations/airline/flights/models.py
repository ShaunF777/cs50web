...
class Flight(models.Model):
    ...
    ''' Reference to Airport model
        indicating that each flight has an origin airport. if the airport is deleted, all flights
        associated with that airport will also be deleted. This is a foreign key relationship.'''
